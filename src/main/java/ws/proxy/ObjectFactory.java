 ...
 * generated in the ws.proxy package. 
...
public class ObjectFactory {
    ...
    private final static QName _ConvertirEuroEnDH_QNAME = new QName("http://ws/", "ConvertirEuroEnDH");
    private final static QName _ConvertirEuroEnDHResponse_QNAME = new QName("http://ws/", "ConvertirEuroEnDHResponse");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: ws.proxy
     * 
     */
    ...
    /**
     * Create an instance of {@link ConvertirEuroEnDH }
     * 
     */
    public ConvertirEuroEnDH createConvertirEuroEnDH() {
        return new ConvertirEuroEnDH();
    }

    /**
     * Create an instance of {@link ConvertirEuroEnDHResponse }
     * 
     */
    public ConvertirEuroEnDHResponse createConvertirEuroEnDHResponse() {
        return new ConvertirEuroEnDHResponse();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConvertirEuroEnDH }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConvertirEuroEnDH }{@code >}
     */
    @XmlElementDecl(namespace = "http://ws/", name = "ConvertirEuroEnDH")
    public JAXBElement<ConvertirEuroEnDH> createConvertirEuroEnDH(ConvertirEuroEnDH value) {
        return new JAXBElement<ConvertirEuroEnDH>(_ConvertirEuroEnDH_QNAME, ConvertirEuroEnDH.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ConvertirEuroEnDHResponse }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link ConvertirEuroEnDHResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://ws/", name = "ConvertirEuroEnDHResponse")
    public JAXBElement<ConvertirEuroEnDHResponse> createConvertirEuroEnDHResponse(ConvertirEuroEnDHResponse value) {
        return new JAXBElement<ConvertirEuroEnDHResponse>(_ConvertirEuroEnDHResponse_QNAME, ConvertirEuroEnDHResponse.class, null, value);
    }
